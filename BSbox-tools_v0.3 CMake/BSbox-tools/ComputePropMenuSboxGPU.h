...
void GPU_Sbox(void) {
	...
	do {
		...
		case 10:
			...
			ReadFromFileComputeANF_degSboxGPU(infile_exampl, 2);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 11:
			...
			//1 - menuChoice for compute deg(S)
			ReadFromFileComputeANF_degSboxGPU(infile_exampl, 3);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 14:
			...
			//1 - menuChoice for compute (bitwise) deg(S)
			ReadFromFileComputeBitwiseANF_degSboxGPU(infile_exampl, 2);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
