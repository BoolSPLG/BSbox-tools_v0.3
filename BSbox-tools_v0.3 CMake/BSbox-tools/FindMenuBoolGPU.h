...
void findGPU_boolMenu(void) {

	printf("\n         BSbox-tools {Find Boolean function (GPU)} \n");
	...
	//set inicial values of the border
	nl_gpuBorder = 0, AC_gpuBorder = 0, deg_gpuBorder = 0, delta_gpuBorder = 0;
}
//=======================================================================================

void findGPU_bool(void) {
	...
	do {
		...
		case 1:
			...
			do {
				cout << "\n  nl(f)=" << nl_gpuBorder << "   Lin(f)=2^n-2*nl(f))" << "\n";
				...
				case 2:
					...
					FindReadFromFileComputeBooleanGPU(infile_exampl, 0, nl_gpuBorder, AC_gpuBorder, deg_gpuBorder);
		...
		case 2:
			...
			do {
				cout << "\n  AC(f)=" << AC_gpuBorder << ";  ==>Set AC(f) bound bigger then 0 \n";
				...
				case 2:
					...
					FindReadFromFileComputeBooleanGPU(infile_exampl, 1, nl_gpuBorder, AC_gpuBorder, deg_gpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 3:
			...
			do {
				cout << "\n  deg(f)=" << deg_gpuBorder << ";  ==>Set border deg(f) not bigger then n\n";
				...
				case 2:
					...
					FindReadFromFileComputeBooleanGPU(infile_exampl, 2, nl_gpuBorder, AC_gpuBorder, deg_gpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 4:
			...
			do {
				cout << "\n  nl(f)=" << nl_gpuBorder << "  ==>Lin(f)=2^n-2*nl(f))" << " ==>search bigger then\n";
				cout << "  AC(f)=" << AC_gpuBorder << ";  ==>Set AC(f) bound bigger then 0 ==>search less then\n";
				cout << "  deg(f)=" << deg_gpuBorder << ";  ==>Set border deg(f) not bigger then n ==>search bigger then\n";
				...
				case 4:
					...
					FindReadFromFileComputeBooleanGPU(infile_exampl, 3, nl_gpuBorder, AC_gpuBorder, deg_gpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 5:
			...
			do {
				...
				case 2:
					...
					//2 - menuChoice Compute : deg(f)
					FindReadFromFileComputeBitWise_ANF_degGPU(infile_exampl, deg_gpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
