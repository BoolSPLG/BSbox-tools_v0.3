...
void findCPU_sboxMenu(void) {

	printf("\n         BSbox-tools {Find S-box(es) (CPU)} \n");
...
void findCPU_sbox(void) {
	...
	do {
		...
		case 1:
			...
			do {
				cout << "\n  nl(S)=" << nl_cpuBorder << "   Lin(S)=2^n-2*nl(S))" << "\n";
				...
				case 2:
					...
					FindReadFromFileComputeSboxCPU(infile_exampl, 0, nl_cpuBorder, AC_cpuBorder, deg_cpuBorder, delta_cpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 2:
			...
			do {
				cout << "\n  AC(S)=" << AC_cpuBorder << ";  ==>Set AC(S) bound bigger then 0 \n";
				...
				case 2:
					...
					FindReadFromFileComputeSboxCPU(infile_exampl, 1, nl_cpuBorder, AC_cpuBorder, deg_cpuBorder, delta_cpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 3:
			...
			do {
				cout << "\n  (max)deg(S)=" << deg_cpuBorder << ";  ==>Set border (max)deg(S) not bigger then n\n";
				...
				case 2:
					...
					FindReadFromFileComputeSboxCPU(infile_exampl, 2, nl_cpuBorder, AC_cpuBorder, deg_cpuBorder, delta_cpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 4:
			...
			do {
				cout << "\n  delta(S)=" << delta_cpuBorder << ";  ==>Set border delta(S) bigger then 2\n";
				...
				case 2:
					...
					FindReadFromFileComputeSboxCPU(infile_exampl, 3, nl_cpuBorder, AC_cpuBorder, deg_cpuBorder, delta_cpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 5:
			...
			do {
				cout << "\n  nl(S)=" << nl_cpuBorder << "  ==>Lin(S)=2^n-2*nl(S))" << " ==>search bigger then\n";
				cout << "  AC(S)=" << AC_cpuBorder << ";  ==>Set AC(S) bound bigger then 0 ==>search less then\n";
				cout << "  (max)deg(S)=" << deg_cpuBorder << ";  ==>Set border (max)deg(S) not bigger then n ==>search bigger then\n";
				cout << "  delta(S)=" << delta_cpuBorder << ";  ==>Set border delta(S) bigger then 2 ==>search less then\n";
				...
				case 5:
					...
					FindReadFromFileComputeSboxCPU(infile_exampl, 4, nl_cpuBorder, AC_cpuBorder, deg_cpuBorder, delta_cpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
		...
		case 6:
			...
			cout << "\n This (bitwise) function will search and save all input S-box(es) above Algebraic degree (max)deg(S) boundary (include (max)deg(S) boundary).\n";
			...
			do {
				...
				case 2:
					...
					//2 - menuChoice Compute: (max)deg(S)
					FindReadFromFileComputeBitwiseANF_degSboxCPU(infile_exampl, 0, deg_cpuBorder);
					cout << "\n Finish ...";
					cout << "\n==========================================================\n";
					PressEnter();
					break;
