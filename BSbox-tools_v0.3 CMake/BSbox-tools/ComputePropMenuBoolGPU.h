...
void GPU_boolMenu(void) {

	printf("\n         BSbox-tools {Boolean function (GPU)} \n");
...
void GPU_bool(void) {
	...
	do {
		...
		case 1:
			...
			ReadFromFileComputeNlGPU(infile_exampl, 0);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 2:
			...
			ReadFromFileComputeNlGPU(infile_exampl, 1);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 3:
			...
			ReadFromFileComputeNlGPU(infile_exampl, 2);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 4:
			...
			ReadFromFileComputeNlGPU(infile_exampl, 3);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 5:
			...
			ReadFromFileComputeACGPU(infile_exampl, 0);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 6:
			...
			ReadFromFileComputeACGPU(infile_exampl, 1);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 7:
			...
			ReadFromFileComputeACGPU(infile_exampl, 2);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 8:
			...
			ReadFromFileComputeANF_degGPU(infile_exampl, 0);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 9:
			...
			ReadFromFileComputeANF_degGPU(infile_exampl, 1);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 10:
			...
			ReadFromFileComputeBitWise_ANFGPU(infile_exampl, 0);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
		...
		case 11:
			...
			ReadFromFileComputeBitWise_ANFGPU(infile_exampl, 1);
			cout << "\n==========================================================\n";
			PressEnter();
			break;
